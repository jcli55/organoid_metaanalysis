...
project <- subsetArchRProject(
  ...
  outputDirectory = "/dfs3b/ruic20_lab/jeancl2/data/archr/chen_D183/",
  dropCells = TRUE,
  force = TRUE
  )
...
plotPDF(p1,p2,p3,p4,p5, name = "Plot-UMAP-Clusters-Chen-D183.pdf", ArchRProj = project, addDOC = FALSE, width = 5, height = 5)
