...
outputDir <- "/dfs3b/ruic20_lab/jeancl2/data/archr/chen_D183"

inputFiles <- c("/dfs3b/ruic20_lab/jinl14/mrrdir/wkfl/hrcaprj/HECA/Organoid_retina/Lattice/Multi_Organoid_D183/cellranger/outs/atac_fragments.tsv.gz")

names <- c("Multi_organoid_D183")
