...
project <- loadArchRProject('/dfs3b/ruic20_lab/jeancl2/data/archr/project/')
...
idxSample <- BiocGenerics::which(project$cellNames %in% names)

project <- subsetArchRProject(
  ArchRProj = project,
  cells = project$cellNames[idxSample],
  outputDirectory = "/dfs3b/ruic20_lab/jeancl2/data/archr/chen_rna_filter/",
  dropCells = TRUE,
  force = TRUE
  )
...
saveArchRProject(project, '/dfs3b/ruic20_lab/jeancl2/data/archr/chen_rna_filter/')