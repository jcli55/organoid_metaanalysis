...
# 4/5/24 - Jean Li
# Updated to run on hpc3 on just the rna filter
# 3/10/25
...
plotPDF(heatmapGS, name = "GeneScores-Marker-Heatmap.pdf", width = 8, height = 6, ArchRProj = project, addDOC = FALSE)
...
heatmapGS@row_order <- c('RHO','RCVRN','CRX','PROM1','ARR3','OTX2','VSX1','VSX2','GAD1','GAD2','TFAP2A','TFAP2B','ONECUT1','ONECUT2','NEFM','RBPMS','POU4F2','RLBP1','SLC1A3','SFRP2')
heatmapGS@column_order <- c('Rod','Cone','BC','AC','HC','RGC','MG','PRPC','NRPC')
...
write.csv(markerList, '/dfs3b/ruic20_lab/jeancl2/data/csv/gene_score_degs.csv')
