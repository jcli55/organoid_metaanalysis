...
# This one plots known lineage markers on the immature cells in RO
...
for subclass in precursors:
        sc.pl.umap(adata, color='subclass', groups=subclass, frameon=False, size=6, title='', legend_loc='none', save=f'_ro_{subclass}.png')
...
for key in gene_list.keys():
        sc.pl.umap(adata, color=gene_list[key], frameon=False, ncols=4, size=6, save=f'_ro_{key}_genes.png')