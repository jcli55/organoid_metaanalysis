...
adata_query = sc.read("/storage/singlecell/jeanl/organoid/data/Chen/chen_fetal_ro_merged_raw.h5ad")
...
sc.pl.umap(
		...
		ncols=1,
		size=3,
		save="_chen_fetal_ro_merged_annotated.png",
)

adata_full.write("/storage/singlecell/jeanl/organoid/data/Chen/chen_fetal_ro_merged_annotated.h5ad")
adata_query.obs.to_csv("/storage/singlecell/jeanl/organoid/data/Chen/chen_fetal_ro_merged_annotated.csv")
