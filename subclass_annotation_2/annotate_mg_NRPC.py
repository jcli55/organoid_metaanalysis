...
# Seeing if there are MG cells in NRPC (especially D206 and wk20/28) or if they are just MG-like
# Runtime: 20min g01

adata = sc.read_h5ad('/storage/singlecell/jeanl/organoid/data/merged_chen/reannotate_w_fetal/subclass_annotation/chen_cherry_merged_NRPC_mg_raw.h5ad')
temp = sc.read_h5ad('/storage/singlecell/jeanl/organoid/data/merged_chen/reannotate_w_fetal/subclass_annotation/chen_cherry_merged_NRPC_mg_raw.h5ad')
...
sc.pl.umap(
    ...
    size=3,
    legend_loc='on data',
    save='chen_cherry_NRPC_mg_leiden.png'
)

#Save h5ad
temp.write_h5ad('/storage/singlecell/jeanl/organoid/data/merged_chen/reannotate_w_fetal/subclass_annotation/chen_cherry_merged_NRPC_mg_umap.h5ad')
...
sc.pl.umap(
    ...
    frameon=False,
    ncols=2,
    save='chen_cherry_NRPC_w_mg_markers.png'
)
'''
