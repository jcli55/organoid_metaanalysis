...
# I'm going to pick out the MG from the PRPC using MG markers
# I could also use the adult MG as reference and do it like the other classes but PRPC is not exaclty a MG precursor
# Runtime: 20min g01

adata = sc.read_h5ad('/storage/singlecell/jeanl/organoid/data/merged_chen/reannotate_w_fetal/subclass_annotation/chen_cherry_merged_PRPC_raw.h5ad')
temp = sc.read_h5ad('/storage/singlecell/jeanl/organoid/data/merged_chen/reannotate_w_fetal/subclass_annotation/chen_cherry_merged_PRPC_raw.h5ad')
...
sc.pl.umap(
    ...
    size=3,
    legend_loc='on data',
    save='chen_cherry_PRPC_leiden.png'
)

#Save h5ad
temp.write_h5ad('/storage/singlecell/jeanl/organoid/data/merged_chen/reannotate_w_fetal/subclass_annotation/chen_cherry_merged_PRPC_umap.h5ad')
...
sc.pl.umap(
    ...
    ncols=2,
    size=3,
    save='chen_cherry_PRPC_mg_markers.png'
)
