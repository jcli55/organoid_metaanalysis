...
# Zhen's cell cycle score code
# Log:
# Used on the overall UMAP - cell_cycle.png
# Used on the MG annotated adata specifically to check annotation

adata = scv.read(
   # "/storage/singlecell/jeanl/organoid/data/merged_chen/cherry_chen_merged_clean.h5ad"
#	"/storage/singlecell/jeanl/organoid/data/merged_chen/subtype_annotation/cherry_chen_mg_annotated.h5ad"
	"/storage/singlecell/jeanl/organoid/data/merged_chen/reannotate_w_fetal/chen_cherry_ro_merged_annotated.h5ad"
)
#adata = adata[adata.obs.sampletype == 'organoid',]
#adata = adata[adata.obs.majorclass != "Astrocyte",]
#adata = adata[adata.obs.majorclass != "RPE",]
#adata = adata[adata.obs.majorclass != "Microglia",]
...
plt.savefig(
    "/storage/singlecell/jeanl/organoid/figures/cell_cycle_reannot_all.png",
    dpi=600,
    bbox_inches="tight",
    transparent=True,
)
