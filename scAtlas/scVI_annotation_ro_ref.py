...
# load reference
adata_ref = sc.read("/storage/singlecell/jeanl/organoid/data/merged_chen/reannotate_w_fetal/chen_cherry_merged_ro_only.h5ad")
#print(adata_ref)
...
adata_query = sc.read("/storage/singlecell/jeanl/organoid/data/other_data_merged/scAtlas/sc_ro_rna_merged_integrated.h5ad")
...
adata_full.write("/storage/singlecell/jeanl/organoid/data/other_data_merged/scAtlas/sc_ro_rna_merged_annotated_ro_ref.h5ad")
...
adata_query.obs.to_csv("/storage/singlecell/jeanl/organoid/data/other_data_merged/scAtlas/sc_ro_rna_merged_annotated_ro_ref.csv")
...
sc.pl.umap(
		...
		ncols=2,
		size=3,
		save="_sc_ro_rna_merged_annotated_ro_ref.png",
)

my_dict = dict.fromkeys(['D24','D30','D42','wk6','D45','D59','D60'], 'early')
my_dict.update(dict.fromkeys(['wk12','D90','D104','D110','wk18','wk24'], 'mid'))
my_dict.update(dict.fromkeys(['D205','wk30','wk38','wk46'], 'late'))
adata_query.obs["age_bin"] = adata_query.obs.age.replace(my_dict) 
sc.pl.umap(
		adata_query,
		color=["source", "majorclass", "age_bin"],
		frameon=False,
		ncols=3,
		size=3,
		save="_sc_ro_rna_merged_annotated_ro_ref_query.png",
)
