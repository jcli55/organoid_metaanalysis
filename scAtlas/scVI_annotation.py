...
adata_query.obs.to_csv("/storage/singlecell/jeanl/organoid/data/other_data_merged/scAtlas/sc_ro_rna_merged_annotated.csv")
...
sc.pl.umap(
		...
		ncols=1,
		size=3,
		save="_sc_ro_rna_merged_annotated.png",
)
